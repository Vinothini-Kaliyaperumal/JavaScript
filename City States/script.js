...
//            literacyRate = 86.20
//            language = 'Hindi'
// The Indian city of Bengaluru has a population 
// of 8443675. language spoken
//  is Kannada a nd litera cy rate is 88.71% 
...
function displayStats(){
    ...
    let text = `The Indian city of ${city} has a population 
     of ${population}. language spoken is ${language} and
